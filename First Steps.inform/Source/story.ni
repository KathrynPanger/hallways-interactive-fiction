...
The Walls is a room.
	"You step into the darkness, and become darkness. You must have lost consiousness, because you awaken standing on a slab of concrete that is four foot square. Around you on every side are grey brick walls that stretch up indefinitely. Your fear resolves into a grim sense of familiarity, as a burden lifts from your shoulders."

The Hallway is a room. 
	"You are in a long hallway.  Identical doors are spaced regularly along the walls on either side. Each door has a sign beside it bearing a room number. There are two doors to your immediate left and right (east and west). The walls are papered. The air feels unnaturally still here."
...
The Room 125 
	...
	The darkness is here. " ".
		The darkness is an opaque closed fixed in place openable container. 
			The description of the darkness is "You look into the darkness. It feels as if it could open up.".
			The black key is in the darkness.
			The description of the black key is "It is a black key. It frightens you."
		 The player is in the Room 125.
...
East of the Outside Room is the Play House. 
	...
	The table is a supporter. The table is here.
		The description of the table is "Yep, that's a table."
