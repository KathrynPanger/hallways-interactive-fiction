...
The Even More Hallway is north of the More Hallway. "You are in a long hallway.  Identical doors are spaced regularly along the walls on either side. Each door has a sign beside it bearing a room number. There are two doors to your immediate left and right (east and west). Near the east door, there is a spot on the wall where the wallpaper is peeling. You see a torn piece."
The torn piece is scenery in the Even More Hallway. "A torn piece of wall paper hangs limply from the wall."
...
The wall paper is a backdrop. "The wall paper is a rich navy and powder-blue damask pattern." The wall paper is in the Corridors.
...
The stove is a opaque closed container. The stove is fixed in place. The stove  is here.
...
the clocks is scenery in the Play House. "Many clocks of different colors are drawn on the walls in crayon. They each tell different times, but strangely, you have trouble reading any of them."
